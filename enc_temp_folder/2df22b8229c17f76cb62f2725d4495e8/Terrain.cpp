...
Terrain::Terrain(const char* heightmapPath, const char* path, const char* normalPath)
{
	...
	//	for (unsigned int j = 0; j < rez; j++)
	//	{
	//		textureCoords.push_back(i / (float)rez); // u
	//		textureCoords.push_back(j / (float)rez); // v

	//		textureCoords.push_back((i + 1) / (float)rez); // u
	//		textureCoords.push_back(j / (float)rez); // v

	//		textureCoords.push_back(i / (float)rez); // u
	//		textureCoords.push_back((j + 1) / (float)rez); // v
